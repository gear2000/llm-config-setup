 ...
 *
 * The problem this solves: every `brain:execute-plan <plan>` startup was a blank slate. If a run
 ...
 * The worker writes this as the FIRST line of results.md (the /run_phase contract), so we scan ALL matches and
