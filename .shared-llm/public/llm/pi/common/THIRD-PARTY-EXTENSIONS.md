...
|------|----------|----------|-----------|
| **OWN** (authored here) | `.shared-llm/public/llm/pi/common/extensions/*.ts` | `llm-config-setup`'s `harness.py link` | **Symlinked** into `~/.pi/` — copied/layered, never installed from a registry |
