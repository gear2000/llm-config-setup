<!-- TEMPLATE — fill in every {{...}} and "FILL THIS OUT" below, then DELETE this banner and rename this file to example_package.md (drop the "TEMPLATE." prefix). List all templates: find . -name 'TEMPLATE.*' -->
