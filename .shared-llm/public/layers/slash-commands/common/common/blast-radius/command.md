...
1. Read the change. The diff, the symbols it adds, changes, and deletes, and what it now does differently, including the part the diff doesn't spell out. Pull the PR description and the commits behind the change when they exist.
...
<!-- Vendored from pstack (MIT, (c) 2026 Lauren Tan), adapted for the shared-llm kit. -->
