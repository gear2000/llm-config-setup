...
```text
GPT 5.5 high codes -> Sonnet 5 high reviews
...
2. Hire GPT 5.5 for the assigned scope. Hire a fresh Sonnet reviewer against its candidate. Return findings to GPT 5.5; keep the same coder model through bounded retries.
