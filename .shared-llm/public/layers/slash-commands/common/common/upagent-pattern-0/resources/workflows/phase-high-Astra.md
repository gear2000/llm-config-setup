...
```text
GPT 6 Astra low codes -> Fable 5.1 adversarial review
  -> required checks + pass -> next phase
```

## Models

- Coder: `pi-gpt-6-astra`, effort `low`.
...
2. Hire Astra for the assigned scope and original acceptance criteria. Hire a fresh Fable adversary against the resulting candidate. Return findings to Astra within the approved retry bound. Exhaustion means stop and ask the human.
