...
Convert a loose Markdown plan into the two-file meta runner input shape. This is the Claude Code equivalent of Pi Harness `meta-plan:convert`.
...
Report whether the output is runnable now or still needs human route completion.
