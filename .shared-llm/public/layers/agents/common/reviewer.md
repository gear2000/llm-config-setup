...
Never report that home skills, `~/.claude`, or `~/.shared-llm/generated` lag this checkout.
`just update` is operator procedure and is assumed. That drift is not a defect, gap, or risk.
