...
To use from another repo, copy this WHOLE directory
(.shared-llm/extensions/this_repo/specialist/) to the same relative path,
add `import '.shared-llm/extensions/this_repo/specialist/justfile'` to the
repo's root justfile, and write agents.yaml next to this file
(template: agents.yaml.example).
"""
...
# hub.py lives at <repo>/.shared-llm/extensions/this_repo/specialist/hub.py;
# the Go hub source sits in the same .shared-llm tree in kit AND destinations.
KIT_HUB_SRC = HERE.parents[2] / "llm/pi/common/extensions/meta-orchestrator-hub/hub"
