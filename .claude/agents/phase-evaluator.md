...
description: Optional independent evaluator for one plan phase. Reviews durable stage evidence from a fresh UpAgent work order and recommends PASSED, FAILED, or BLOCKED.
model: sonnet
color: purple
---
