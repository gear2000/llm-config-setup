---
name: plan-adversary
description: Read-only adversarial reviewer for approved candidate plans. Challenges feasibility, missing decisions, phase boundaries, tests, rollback, parallel safety, and acceptance before implementation.
---
