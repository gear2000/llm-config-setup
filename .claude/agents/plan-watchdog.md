---
name: plan-watchdog
description: Optional plan-phase conformance advisor. Reviews durable evidence for a managed phase and returns ON_TRACK, REWORK, or BLOCKED; never patrols persistently or writes phase results.
model: sonnet
color: orange
---
