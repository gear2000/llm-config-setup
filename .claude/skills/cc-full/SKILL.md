---
name: cc-full
description: 'Claude Code planning conductor: research and grill a plan, create and check the canonical `plan.md` + `route.yaml` pair, then stop with the explicit Herdr handoff. It does not execute implementation.'
---
