---
name: do-full
description: 'Pi planning conductor: run the Pi grill, create and check the canonical `plan.md` + `route.yaml` pair, then stop with the explicit Herdr handoff. It does not execute implementation.'
---
