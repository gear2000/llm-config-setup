---
name: do-full
description: Disabled composer. Warns and stops. Use `/do-plan`, then a Claude Code `/hil --plan <plan.md>` session for Flow 1 execution. Use when someone invokes `/do-full`.
---
