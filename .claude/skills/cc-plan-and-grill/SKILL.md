...
description: 'Claude Code planning front door: research, grill, produce and check `plan.md` + `route.yaml`, then stop with the explicit `herdr-run` handoff. The command does not execute implementation.'
---
